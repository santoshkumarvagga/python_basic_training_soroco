...
class AboutControlStatements(Koan):
    ...
    def test_conditional_pitfalls(self):
        self.assertEqual(____, 0 == False)
        self.assertEqual(____, 0 is False)
        self.assertEqual(____, 0 is None)

        self.assertEqual(____, 1 == True)
        self.assertEqual(____, 1 is True)
        self.assertEqual(____, 2 == True)
        self.assertEqual(____, bool(2) == True)  # Check with other non-zero values
        self.assertEqual(____, -1 == False)
