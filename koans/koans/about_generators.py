...
class AboutGenerators(Koan):
    ...
    def test_generators_are_different_to_list_comprehensions(self):
        ...
        self.assertEqual(__, num_list[0])

        # A generator has to be iterated through.
        with self.assertRaises(__): num = num_generator[0]
    ...
    def test_generators_can_see_if_they_have_been_called_with_a_value(self):
        ...
        next(generator)
        self.assertEqual(__, generator.send('with value'))
    ...
    # You would use generators only in cases when you want to do lazy evaluation like to save memory.
