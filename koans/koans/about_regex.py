...
class AboutRegex(Koan):
    ...
    def test_matching_literal_text_how_many(self):
        ...
        # I want to know how many times "my name" (case insensitive) appears
    ...
    def test_matching_any_character(self):
        ...
        # Find all the files whose name is either prefixed with South America (sa) or
        # North America (na)
    ...
    def test_anything_but_matching(self):
        ...
        # I want to find the complete filename wherever the filename (without extension) is 'sam'
        change_this_search_string = '[^nc]am.xls'
        self.assertEquals(
            re.findall(change_this_search_string, string),
            ['sam.xls', 'sam.tar.gz', 'sam.pdf'])
