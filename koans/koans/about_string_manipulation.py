...
class AboutStringManipulation(Koan):
    ...
    def test_use_named_placeholders_formatting(self):
        value1 = 'doh'
        value2 = 'DOH'
        # This is much more readable and preferred way for formatting
        string = "We got {error}, with reason code {code}!".format(error=value1, code=value2)
        self.assertEqual(__, string)
    ...
    def test_string_comparison(self):
        string1 = "Guido"
        string2 = "guido "
        # Many times is it useful to normalize string before comparision, make it lowercase
        # and remove leading/trailing whitespaces
        normalized_string1 = string1
        normalized_string2 = string2

        self.assertEqual(normalized_string1, normalized_string2)
