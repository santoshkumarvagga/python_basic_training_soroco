...
class AboutAttributeAccess(Koan):
    ...
    # DO NOT redefine __getattribute__  in practice, the below exercises are just for knowledge
    ...
    def test_non_foo_messages_are_treated_normally(self):
        ...
        with self.assertRaises(__): catcher.normal_undefined_attribute
    ...
    # ------------------------------------------------------------------
    # DO NOT define __getattr__  in practice, the below exercises are just for knowledge
