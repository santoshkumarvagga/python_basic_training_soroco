...
class AboutMonkeyPatching(Koan):
    ...
    # AVOID doing this unless you know what you are doing. Define all methods in the class, beforehand.
    def test_after_patching_dogs_can_both_wag_and_bark(self):
        def wag(self): return "HAPPY"

        # NOTE: This way of programming is NOT recommended, use inheritance instead
        self.Dog.wag = wag
